...
from ImportSubcomponent import ImportManager
from ExportSubcomponent import ExportManager
...
class PackagerTabWindow(QTabWidget):
    ...
    def export_UI(self):
        ...
        export_subcomp = ExportManager(self)
        tab2_layout.addWidget(export_subcomp)
